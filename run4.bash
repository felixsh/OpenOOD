...
RUN2=/mrtstorage/users/truetsch/neural_collapse_runs/benchmarks/imagenet200/ResNet18_224x224/no_noise/500+_epochs/run_e500_2024_11_12-22_24_32
...
CUDA_VISIBLE_DEVICES=1 python eval_main.py run=$RUN2 ood=$OOD &
wait $(jobs -p)
